...
public class MainGame {
    ...
    public MainGame() {
        ...
        player1 = new Players(Space.GREEN, 1);
        player2 = new Players(Space.WHITE, 2);
    }
    ...
    public void Play() {
        ...
        while (true) {
            ...
            System.out.println("Players 1 (.R):  Enter a location number.");
            int location = myScan.nextInt();

            if (this.gameBoard.spaces[location] == Space.GREEN || this.gameBoard.spaces[location] == Space.WHITE || this.gameBoard.spaces[location] == Space.UNDEFINED) {
            ...
            System.out.println("Players 2 (.Y):  Enter a location number.");
            location = myScan.nextInt();
            ...
            if (ifWon) {
                System.out.println("Players 2 Wins");
                gameBoard.Draw();
                return;
            }
    ...
    private boolean SpaceStatus(){
        ...
        for(int i = 7; i < this.gameBoard.spaces.length; i++){
            ...
            } else if(this.gameBoard.spaces[i] == Space.GREEN || this.gameBoard.spaces[i] == Space.WHITE){
        ...
        for(int j = 0; j < this.gameBoard.spaces.length; j++){
            ...
            if(this.gameBoard.spacesText[j] == ".R"){
                this.gameBoard.spaces[j] = Space.GREEN;
            } else if(this.gameBoard.spacesText[j] == ".Y"){
                this.gameBoard.spaces[j] = Space.WHITE;
            }
